...
export default class Bot 
{
  ...
  */
    ...
    var bskyFeedAwait = await this.userAgent.app.bsky.feed.getAuthorFeed({actor: "oilersmirror.bsky.social", limit: postNum,}); // Get a defined number + 2 of most recent posts from the logged in user's feed.
      ...
      if (card != "None" && urls[0] == "None")
      {
        ...
        var cardBuffer = Buffer.from(cardResponse.data, "utf-8");
          if (cardBuffer.length > 1000000)
          {
            ...
            cardResponse = await axios.get("https://content.sportslogos.net/logos/1/12/full/hf9hulfgfaanvoww9aq8tjvhv.png", { responseType: 'arraybuffer'}); 
